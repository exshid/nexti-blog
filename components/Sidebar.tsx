...
interface PostListProps {
  ...
  export const Sidebar: React.FC<PostListProps> = ({ posts }) => {
    ...
    return <><h2 className="border-t border-reddish border-t-8 rounded-tr-lg text-right text-midnightish p-4 inline-block w-full self-end uppercase dark:text-white">Recent Posts</h2>
