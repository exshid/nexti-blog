...
type Props = {
    ...
    {tags.map((it, i) => (
<li key={i} style={{width: '32.5%'}} className="rounded-lg mt-3 dark:bg-evening bg-daylight dark:hover:bg-lightnight dark:text-white inline-block h-1/3 p-6 pt-4">            <TagLink tag={it} />
</li>
))}
</ul>
</div>
