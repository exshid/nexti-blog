...
type Props = {
    ...
    {tags.map((it, i) => (
<li key={i} className="rounded-lg mb-3 dark:bg-evening bg-daylight dark:hover:bg-lightnight dark:text-white w-2/6 inline-block h-1/3 p-6 pt-4">            <TagLink tag={it} />
</li>
))}
</ul>
</div>
