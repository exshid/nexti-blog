...
return <div className="relative w-full h-full flex justify-center md:h-auto">
    <div className="relative rounded-lg w-full lg:w-1/2">
        <div className="flex items-start justify-between py-4 rounded-t">
  ...
  <div className="mb-6">
    ...
    <input placeholder="Your name" type="text" id="text" className="bg-gray-50 border border-gray-300 dark:border-none text-gray-900 text-sm rounded-lg focus:ring-darker-reddish focus:border-darker-reddish block w-full p-2.5 dark:bg-lightnight dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-darker-reddish dark:focus:border-darker-reddish" required/>
  </div>
  <div className="mb-6">
    <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Your email</label>
    <input placeholder="Your email" type="email" id="email" className="bg-gray-50 border border-gray-300 dark:border-none text-gray-900 text-sm rounded-lg focus:ring-darker-reddish focus:border-darker-reddish block w-full p-2.5 dark:bg-lightnight dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-darker-reddish dark:focus:border-darker-reddish" required/>
  </div>
  <div className="mb-6">

  <label htmlFor="message" className="block mb-2 text-sm font-medium sr-only text-gray-900 dark:text-white">Your message</label>
<textarea id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 dark:border-none rounded-lg border border-gray-300 focus:ring-darker-reddish focus:border-darker-reddish dark:bg-lightnight dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-darker-reddish dark:focus:border-darker-reddish" placeholder="Leave a comment..."></textarea>
</div>
