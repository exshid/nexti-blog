...
<nav className="bg-white header-shadow px-2 sm:px-4 py-2.5 dark:bg-midnightish transition w-full z-20 top-0 left-0 rounded-lg border border-grayish dark:border-none">
  ...
  <div className="block space-y-4 md:flex md:space-y-0 md:space-x-4">
    <button onClick={searchHandler} className="block w-full md:w-auto hover:bg-grayish dark:hover:bg-lightnight transition transition rounded-3xl text-white focus:ring-2 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-gray-600" type="button">
