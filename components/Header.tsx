...
<nav className="bg-white header-shadow px-2 sm:px-4 py-2.5 dark:bg-midnightish transition w-full z-20 top-0 left-0 rounded-lg border border-grayish dark:border-none">
  ...
  <div className="block space-y-4 md:flex md:space-y-0 md:space-x-4">
    <button onClick={searchHandler} className="block w-full md:w-auto hover:bg-grayish dark:hover:bg-gray-400 transition transition rounded-3xl text-white focus:ring-2 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-midnightish dark:focus:ring-gray-600" type="button">
    <svg aria-hidden="true" className="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>    </button>
      ...
      <button onClick={classesHander} type="button" className="hover:bg-grayish dark:hover:bg-gray-400 transition rounded-3xl inline-flex items-center mr-1 p-2 text-sm text-gray-500 rounded-lg md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:focus:ring-gray-600" aria-controls="navbar-sticky" aria-expanded="false">
 ...
 {dropdown && <div id="mega-menu-full-dropdown" className='mt-1 border-gray-200 shadow-sm bg-gray-50 md:bg-white border-y dark:bg-midnightish dark:border-gray-600'>
        ...
        <ul onClick={dropdownCloseHandler}>
         ...
         <div className="w-4/5">
                        ...
                        <span className="text-sm invisible md:visible font-light text-gray-500 dark:text-gray-400">{post.description}</span>
                </div>
                </li>
                    </a>
                </Link>
