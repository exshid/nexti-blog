...
alt={alt}
/>
<figure style={{position: 'absolute', height: '190px', background: 'linear-gradient(70deg, rgba(20, 20, 20, 1), rgba(20, 20, 20, 0))'}} className="w-full transition group recent-posts rounded-lg flex flex-col items-center justify-center px-8 text-center dark:border-none border border-grayish transition">
                <blockquote className="self-start text-left text-white">
