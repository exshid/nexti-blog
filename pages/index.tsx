...
<h2 className="bg-reddish rounded-tl-lg p-4 inline-block uppercase text-white">Recent Posts</h2>
      ...
      {buttonReturn && <button className="p-4 bg-reddish hover:bg-darker-reddish rounded-bl-lg text-white transition flex" onClick={postNumberHandler}><p className="mr-1">Load More Posts </p><ArrowRight
        ...
        <div className="w-full flex flex-col dark:border-none border border-grayish mt-3 md:mt-0 md:w-3/12 h-auto"><Sidebar posts={posts.slice(0, 10)}/></div>
</div>
</main>
        </Layout>
        </>
