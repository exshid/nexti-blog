...
<div className="flex w-full flex-col">
    <div className="flex flex-col-reverse md:flex-row">
      <div className="border-t mt-3 md:mt-0  border-reddish border-t-8 rounded-lg md:rounded-t-lg w-full md:w-9/12 mr-4">
...
<a className="w-full mt-3 md:mt-0 md:w-1/2 ml-3 group">
      ...
      <div className="w-full md:w-3/12 h-auto rounded-lg"> 
